...
<template>
    <div class="flex flex-col gap-4">
        <CompanyIndex v-if="view === 'index'" :companies="companies" @create="showCreate" @edit="showEdit" />

        <CompanyCreate v-if="view === 'create'" @cancel="showIndex" @created="handleDataChanged" />
        ...
        />
        <EmployeeCreate v-if="view === 'employee-create'" :company="selectedCompany" @cancel="showIndex" @created="handleDataChanged" />
    </div>
</template>
